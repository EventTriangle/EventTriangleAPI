...
public class SuspendUserCommandHandler : ICommandHandler<SuspendUserBody, UserSuspendedEvent>
{
    ...
    public async Task<IResult<UserSuspendedEvent, Error>> HandleAsync(ICommand<SuspendUserBody> command)
    {
